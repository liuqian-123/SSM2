	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="${pageContext.request.contextPath}/" class="now" target="right">查看所有</a></li>
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="<%=request.getContextPath() %>/SelectProductServlet" target="right" class="now">查看所有</a></li>
        ...
        %>
       <iframe src="${pageContext.request.contextPath}/manage/user.jsp?userName=${userName}" frameborder="0" name="right" width="970" height="1000" ></iframe>
    </div>
